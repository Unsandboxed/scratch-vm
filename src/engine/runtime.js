...
const RuntimeInternals = {
    ...
    ArgumentTypeMap: (() => {
        ...
        map[ArgumentType.VECTOR] = {
            ...
            check: ['Vector', 'Position', 'Array', 'String']
        };
        map[ArgumentType.POSITION] = {
            ...
            check: ['Position', 'Vector', 'Array', 'String']
        };
...
class Runtime extends RuntimeConstants {
    ...
    _convertBlockForScratchBlocks (blockInfo, categoryInfo) {
        ...
        case BlockType.OBJECT:
            ...
            break;
        default: {
            if (!categoryInfo.customShapes[blockInfo.blockType]) break;
            const shape = categoryInfo.customShapes[blockInfo.blockType];
            shape.output = shape.output || null;
