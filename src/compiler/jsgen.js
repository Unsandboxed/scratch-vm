...
class JSGenerator {
    ...
    descendInput (node) {
        ...
        case 'op.lettersOf':
            return new TypedInput(`((${this.descendInput(node.string).asString()}).substring(${this.descendInput(node.letter1).asNumber() - 1}, ${this.descendInput(node.letter2).asNumber()} - 1) || "")`, TYPE_STRING);
        case 'op.ln':
